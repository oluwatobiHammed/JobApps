 ...
 @IBInspectable var leftImage: UIImage? {
    ...
    func updateView() {
        ...
        attributedPlaceholder = NSAttributedString(string: placeholder != nil ?
            placeholder! :"", attributes:[NSAttributedString.Key.foregroundColor: UIColor.lightGray])
    }
    ...
    func setLeftImage() {
        ...
        if let image = leftImage {
            let imageView = UIImageView(frame: CGRect(x: leftPadding, y: 3, width: 20, height: 15))
            ...
            view = UIView(frame: CGRect(x: 0, y: 10, width: width, height: 20))
